...
Type
  ...
  private
    ...
    Fedition_number: Integer;
    Fpadv_date: TDAte;
    Fpadv_number: Integer;
    ...
    procedure setFedition_number(const Value: Integer);
    procedure setFpadv_date(const Value: TDAte);
    procedure setFpadv_number(const Value: Integer);
  ...
  public
    ...
    [FieldName('padv_number')]
    property PADVNumber: Integer read Fpadv_number write setFpadv_number;

    [FieldName('padv_date')]
    property PADVData: TDAte read Fpadv_date write setFpadv_date;

    [FieldName('edition_number')]
    property NumeroEdicao: Integer read Fedition_number write setFedition_number;
...
procedure TOrderPi.setFedition_number(const Value: Integer);
begin
  Fedition_number := Value;
end;
...
procedure TOrderPi.setFpadv_date(const Value: TDAte);
begin
  Fpadv_date := Value;
end;

procedure TOrderPi.setFpadv_number(const Value: Integer);
begin
  Fpadv_number := Value;
end;
