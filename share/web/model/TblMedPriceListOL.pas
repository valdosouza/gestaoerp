...
Type
  ...
  public
    ...
    [FieldName('position')]
    property ChaPosicao: Integer  read Fposition write setFposition;
...
procedure TMedPriceListOL.setFchannel_kind(const Value: String);
begin
  Fchannel_kind := Value;
end;
...
procedure TMedPriceListOL.setFtb_med_pos_prog_id(const Value: Integer);
begin
