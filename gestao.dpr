...
begin
  ...
  Application.CreateForm(TRegCollaborator, RegCollaborator);
  Application.CreateForm(TRegJobPosition, RegJobPosition);
  Application.CreateForm(TSeaCollaborator, SeaCollaborator);
  Application.CreateForm(TSeaJobPosition, SeaJobPosition);
  Application.CreateForm(TRegCommitment, RegCommitment);
  Application.CreateForm(TRegConfigTag, RegConfigTag);
  Application.CreateForm(TRegPrinters, RegPrinters);
  Application.CreateForm(TRegUsers, RegUsers);
  Application.CreateForm(TRegVirtualShop, RegVirtualShop);
  Application.CreateForm(TSeaPrinters, SeaPrinters);
  Application.CreateForm(TSeaUsers, SeaUsers);
  Application.CreateForm(TRegBannerSite, RegBannerSite);
  Application.CreateForm(TRegCategory, RegCategory);
  Application.CreateForm(TRegCity, RegCity);
  Application.CreateForm(TRegExtMotive, RegExtMotive);
  Application.CreateForm(TRegGroupMenu, RegGroupMenu);
  Application.CreateForm(TRegPackage, RegPackage);
  Application.CreateForm(TRegSubgroupMenu, RegSubgroupMenu);
  Application.CreateForm(TRegUf, RegUf);
  Application.CreateForm(TSeaBannerSite, SeaBannerSite);
  Application.CreateForm(TSeaCategory, SeaCategory);
  Application.CreateForm(TSeaCity, SeaCity);
  Application.CreateForm(TSeaConfigTag, SeaConfigTag);
  Application.CreateForm(TSeaExtMotive, SeaExtMotive);
  Application.CreateForm(TSeaGroupMenu, SeaGroupMenu);
  Application.CreateForm(TSeaPackage, SeaPackage);
  Application.CreateForm(TSeaUf, SeaUf);
  Application.CreateForm(TRegReceipt, RegReceipt);
  Application.Run;
end.
