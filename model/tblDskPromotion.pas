...
Type
  ...
  private
    ...
    procedure setFDT_EXPIRATION(const Value: TDate);
  ...
  public
    ...
    property DataValidade: TDate read FDT_EXPIRATION write setFDT_EXPIRATION;
...
procedure TDskPromotion.setFDT_EXPIRATION(const Value: TDate);
begin
