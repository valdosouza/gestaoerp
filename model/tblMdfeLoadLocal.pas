...
Type
  ...
  [TableName('TB_MDFE_LOAD_LOCAL')]
  TMdfeLoadLocal = Class(TGenericEntity)
...
procedure TMdfeLoadLocal.setFTB_CITY_ID(const Value: Integer);
begin
  FTB_CITY_ID := Value;
end;

procedure TMdfeLoadLocal.setFTB_INSTITUTION_ID(const Value: Integer);
begin
  FTB_INSTITUTION_ID := Value;
end;

procedure TMdfeLoadLocal.setFTB_MDFE_ID(const Value: Integer);
begin
  FTB_MDFE_ID := Value;
end;

procedure TMdfeLoadLocal.setFTB_STATE_ID(const Value: Integer);
begin
  FTB_STATE_ID := Value;
end;
