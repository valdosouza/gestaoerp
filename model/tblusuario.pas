...
Type
  ...
  private
    ...
    FUSU_AUTH_CARD: String;
    FUSU_NOTIFICA: String;
    ...
    procedure setFUSU_LEVEL(const Value: String);
    ...
    procedure setFUSU_AUTH_CARD(const Value: String);
    procedure setFUSU_NOTIFICA(const Value: String);
  ...
  public
    ...
    [FieldName('USU_LEVEL')]
    property Nivel: String read FUSU_LEVEL write setFUSU_LEVEL;
    ...
    [FieldName('USU_NOTIFICA')]
    property NotificarPorEmail: String read FUSU_NOTIFICA write setFUSU_NOTIFICA;

    [FieldName('USU_AUTH_CARD')]
    property CartaoAutorizacao: String read FUSU_AUTH_CARD write setFUSU_AUTH_CARD;
  End;
...
procedure TUsuario.setFUSU_AUTH_CARD(const Value: String);
begin
  FUSU_AUTH_CARD := Value;
end;
...
procedure TUsuario.setFUSU_LEVEL(const Value: String);
begin
  FUSU_LEVEL := Value;
end;
...
procedure TUsuario.setFUSU_NOTIFICA(const Value: String);
begin
  FUSU_NOTIFICA := Value;
end;
