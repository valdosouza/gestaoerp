...
Type
  ...
  [TableName('TB_TRIB_MOD_DET_BC_ICMS')]
  TTaxModeDetBcIcms = Class(TGenericEntity)
...
procedure TTaxModeDetBcIcms.setFMDB_CODIGO(const Value: Integer);
begin
  FMDB_CODIGO := Value;
end;

procedure TTaxModeDetBcIcms.setFMDB_DESCRICAO(const Value: String);
begin
  FMDB_DESCRICAO := Value;
end;

procedure TTaxModeDetBcIcms.setFMDB_GRUPO(const Value: String);
begin
  FMDB_GRUPO := Value;
end;
