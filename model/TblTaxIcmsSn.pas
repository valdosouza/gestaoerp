...
procedure TTaxIcmsSn.setFTBI_CODIGO(const Value: Integer);
begin
  FTBI_CODIGO := Value;
end;

procedure TTaxIcmsSn.setFTBI_DESCRICAO(const Value: String);
begin
  FTBI_DESCRICAO := Value;
end;

procedure TTaxIcmsSn.setFTBI_GRUPO(const Value: String);
begin
  FTBI_GRUPO := Value;
end;
