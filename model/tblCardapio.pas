...
Type
  ...
  TCardapio = Class(TGenericEntity)
  private
...
procedure TCardapio.setFPRO_ALTURA(Value: Real);
begin
  FPRO_ALTURA := Value;
end;

procedure TCardapio.setFPRO_APLICACAO(Value: String);
begin
  FPRO_APLICACAO := Value;
end;

procedure TCardapio.setFPRO_ATIVO(Value: String);
begin
  FPRO_ATIVO := Value;
end;

procedure TCardapio.setFPRO_CAMPANHA(Value: String);
begin
  FPRO_CAMPANHA := Value;
end;

procedure TCardapio.setFPRO_CEST(Value: String);
begin
  FPRO_CEST := Value;
end;

procedure TCardapio.setFPRO_CODCAT(Value: INTEGER);
begin
  FPRO_CODCAT := Value;
end;

procedure TCardapio.setFPRO_CODEMB(Value: INTEGER);
begin
  FPRO_CODEMB := Value;
end;

procedure TCardapio.setFPRO_CODGRP(Value: INTEGER);
begin
  FPRO_CODGRP := Value;
end;

procedure TCardapio.setFPRO_CODIGO(Value: INTEGER);
begin
  FPRO_CODIGO := Value;
end;

procedure TCardapio.setFPRO_CODIGOBAR(Value: String);
begin
  FPRO_CODIGOBAR := Value;
end;

procedure TCardapio.setFPRO_CODIGOFAB(Value: String);
begin
  FPRO_CODIGOFAB := Value;
end;

procedure TCardapio.setFPRO_CODIGOFOR(Value: String);
begin
  FPRO_CODIGOFOR := Value;
end;

procedure TCardapio.setFPRO_CODIGONCM(Value: String);
begin
  FPRO_CODIGONCM := Value;
end;

procedure TCardapio.setFPRO_CODMED(Value: INTEGER);
begin
  FPRO_CODMED := Value;
end;

procedure TCardapio.setFPRO_CODMHA(Value: INTEGER);
begin
  FPRO_CODMHA := Value;
end;

procedure TCardapio.setFPRO_CODMRC(Value: INTEGER);
begin
  FPRO_CODMRC := Value;
end;

procedure TCardapio.setFPRO_CODRVT(Value: INTEGER);
begin
  FPRO_CODRVT := Value;
end;

procedure TCardapio.setFPRO_CODSBG(Value: INTEGER);
begin
  FPRO_CODSBG := Value;
end;

procedure TCardapio.setFPRO_COMPOSICAO(Value: String);
begin
  FPRO_COMPOSICAO := Value;
end;

procedure TCardapio.setFPRO_COMPRIMENTO(Value: Real);
begin
  FPRO_COMPRIMENTO := Value;
end;

procedure TCardapio.setFPRO_DESCRICAO(Value: String);
begin
  FPRO_DESCRICAO := Value;
end;

procedure TCardapio.setFPRO_DESTAQUE(Value: String);
begin
  FPRO_DESTAQUE := Value;
end;

procedure TCardapio.setFPRO_DETALHES(Value: String);
begin
  FPRO_DETALHES := Value;
end;

procedure TCardapio.setFPRO_DIVISOR(Value: INTEGER);
begin
  FPRO_DIVISOR := Value;
end;

procedure TCardapio.setFPRO_EST_NEG(Value: String);
begin
  FPRO_EST_NEG := Value;
end;

procedure TCardapio.setFPRO_EXCLUSIVO(Value: String);
begin
  FPRO_EXCLUSIVO := Value;
end;

procedure TCardapio.setFPRO_FORA_LINHA(Value: String);
begin
  FPRO_FORA_LINHA := Value;
end;

procedure TCardapio.setFPRO_IMPRIME(Value: String);
begin
  FPRO_IMPRIME := Value;
end;

procedure TCardapio.setFPRO_INTERNET(Value: String);
begin
  FPRO_INTERNET := Value;
end;

procedure TCardapio.setFPRO_LARGURA(Value: Real);
begin
  FPRO_LARGURA := Value;
end;

procedure TCardapio.setFPRO_LOCAL(Value: String);
begin
  FPRO_LOCAL := Value;
end;

procedure TCardapio.setFPRO_MAISVENDIDO(Value: String);
begin
  FPRO_MAISVENDIDO := Value;
end;

procedure TCardapio.setFPRO_ORIGEM(Value: String);
begin
  FPRO_ORIGEM := Value;
end;

procedure TCardapio.setFPRO_PESO(Value: Real);
begin
  FPRO_PESO := Value;
end;

procedure TCardapio.setFPRO_QTDE_MIN(Value: Real);
begin
  FPRO_QTDE_MIN := Value;
end;

procedure TCardapio.setFPRO_SERIE(Value: String);
begin
  FPRO_SERIE := Value;
end;

procedure TCardapio.setFPRO_SUB_TRIB(Value: String);
begin
  FPRO_SUB_TRIB := Value;
end;

procedure TCardapio.setFPRO_TIPO(Value: String);
begin
  FPRO_TIPO := Value;
end;

procedure TCardapio.setFPRO_TRIBUTACAO(Value: String);
begin
  FPRO_TRIBUTACAO := Value;
end;

procedure TCardapio.setFPRO_VENDA(Value: String);
begin
  FPRO_VENDA := Value;
end;

procedure TCardapio.setFPRO_VL_CUSTO(Value: Real);
begin
  FPRO_VL_CUSTO := Value;
end;

procedure TCardapio.setFPRO_VL_CUSTOANT(Value: Real);
begin
  FPRO_VL_CUSTOANT := Value;
end;

procedure TCardapio.setFPRO_VL_CUSTOMED(Value: Real);
begin
  FPRO_VL_CUSTOMED := Value;
end;

procedure TCardapio.setFPRO_VL_CUSTOMEDANT(Value: Real);
begin
  FPRO_VL_CUSTOMEDANT := Value;
end;

procedure TCardapio.setFPRO_VL_FABRICA(Value: Real);
begin
